...
export class UserProfilePageComponent implements OnInit {
  ...
  edit_fullnamee : string;
  edit_usernamee : string;
  edit_mobilee : string;
  edit_emaile : string;
  edit_parent_mobilee : string;
  edit_passworde : string;
  edit_re_passworde : string;
  choice : string = 'none';
      ...
      new Promise( (resolve,reject) => {
        setTimeout(() => {
          try {
            ...
            this.edit_fullnamee = this.user.fullname;
            this.edit_usernamee = this.user.username;
            this.edit_emaile = this.user.email;
            this.edit_mobilee = this.user.mobile;
            this.edit_parent_mobilee = this.user.parent_mobile;
